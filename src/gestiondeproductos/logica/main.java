...
//
//public class main { //exportar productos a Json.
...
//        gestor.crear(new Electronico(2, "Smartphone", 500.0, TipoElectronico.TELEFONO, 50, 456)); // use el enumerado de electronico
...
//
//        System.out.println("Productos exportados a 'productos.json' con exito!!!");
//    }
//}